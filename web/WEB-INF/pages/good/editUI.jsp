...
<div class="col-md-10 column" style="height: 100vh">
    ...
    <div class="form" style="padding:40px; ">
        <form class="form-horizontal" role="form" action="/good">
            <div class="form-group" style="display: none;">
                <input type="hidden" name="method" value="add" class="form-control">
            </div>
            <div class="form-group">
                <label>手机型号</label>
                <input name="mobileVersion" type="text" class="form-control">
            </div>
            <div class="form-group">
                <label>手机名</label>
                <input name="mobileName" type="text" class="form-control">
            </div>

            <div class="form-group">
                <label>手机制造商</label><br/>
                <input name="mobileMade" type="text" class="form-control">
            </div>

            <div class="form-group">
                <label>手机价格</label>
                <input name="mobilePrice" type="text" class="form-control">
            </div>

            <div class="form-group">
                <label>手机类别</label>
                <select class="form-control" name="mobileClassify">
                    <c:forEach items="${classifies}" var="item" >
            ...
            <div class="form-group">
                <label>手机信息</label>
                <input name="mobileMess" type="text" class="form-control" value="">
            </div>

            <div class="form-group">
                <label>手机图片</label>
                <input name="mobilePic" type="text" class="form-control" value="">
            </div>
